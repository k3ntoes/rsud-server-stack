...
**Thumbnail**:
Aspect-ratio-preserved compressed version of the original photo, generated asynchronously for lazy-load in the web dashboard.
...
- Thumbnails: aspect ratio preserved, generated asynchronously via background jobs
- Local storage via Docker volume (upgradeable)

## ADRs

See `docs/adr/` in this context directory for media-specific decisions.
