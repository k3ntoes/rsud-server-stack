  ...
  return (
    <div className="animate-fade-in">
      <div className="page-header">
        <div>
          <h1 className="page-title">Item Inspeksi</h1>
          <p className="page-subtitle">
            Kelola item yang dinilai dalam inspeksi kebersihan
          </p>
        </div>
                  ...
                  <tr key={item.id}>
                    ...
                    <td className="text-right">
                      ...
                      <button
                        onClick={() => {
                          if (
                            window.confirm(`Hapus item "${item.name}"?`)
                          ) {
      ...
      >
        <label className="label-plan">Nama Item</label>
        <input
          type="text"
          value={nameInput}
